(function() {
  ...
  */
  ...
  function showLoadingMessage(msg) {
    var resturantList = document.getElementsByClassName('restaurant-list');
    resturantList[0].innerHTML = '<p class="notice"><i class="fa fa-spinner fa-spin"></i> '+ msg + '</p>';
  }

  function showWarningMessage(msg) {
    var resturantList = document.getElementsByClassName('restaurant-list');
    resturantList[0].innerHTML = '<p class="notice"><i class="fa fa-exclamation-triangle"></i> ' + msg + '</p>';
  }

  function showErrorMessage(msg) {
    var resturantList = document.getElementsByClassName('restaurant-list');
    resturantList[0].innerHTML = '<p class="notice"><i class="fa fa-exclamation-circle"></i> ' + msg + '</p>';
  }
  ...
  // -------------------------------------
	...
	function loadNearbyItems() {
		console.log('loadNearbyResturants');
